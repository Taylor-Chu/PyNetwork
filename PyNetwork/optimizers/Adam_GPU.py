...
class Adam(Optimizer):
    ...
    def __init__(self, context, queue, gpuoperator, learning_rate=0.001, b1=0.9, b2=0.999, e=1e-8):
    ...
    def step(self, grad_dict):
        ...
        return {key: self.gpuoperator.div(a * m, self.gpuoperator.pow(v,0.5) + self.e) if v is not None else None
